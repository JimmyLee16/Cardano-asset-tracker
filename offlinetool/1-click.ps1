...
# Derive payment key (child) and export public key WITHOUT chain code (addr.xvk)
Write-Host "Deriving payment private key (1852H/1815H/0H/0/0) -> addr.xsk"
Get-Content .\root.xsk -Raw | & $cardanoExe key child 1852H/1815H/0H/0/0 > .\addr.xsk
...
# Derive stake key (child) and export public key WITHOUT chain code (stake.xvk)
Write-Host "Deriving stake private key (1852H/1815H/0H/2/0) -> stake.xsk"
Get-Content .\root.xsk -Raw | & $cardanoExe key child 1852H/1815H/0H/2/0 > .\stake.xsk
